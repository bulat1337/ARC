...
{
	test_utils::run_test<int>("/edge_cases/ignore", utils::Cache_type::perfect);
}
...
{
	test_utils::run_test<int>("/uniform_distribution/cache-5_data-100", utils::Cache_type::perfect);
}

TEST(uniform_distribution, cache_10_data_10000)
{
	test_utils::run_test<int>("/uniform_distribution/cache-10_data-10000", utils::Cache_type::perfect);
}

TEST(common, basic)
{
	test_utils::run_test<int>("/common/basic", utils::Cache_type::perfect);
}
